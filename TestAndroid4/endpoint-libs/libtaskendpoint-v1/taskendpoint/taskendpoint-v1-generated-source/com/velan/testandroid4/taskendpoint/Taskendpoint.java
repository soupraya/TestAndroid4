 ...
 * on 2015-04-01 at 16:04:39 UTC 
 * Modify at your own risk.
 */

package com.velan.testandroid4.taskendpoint;
...
public class Taskendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetTask extends TaskendpointRequest<com.velan.testandroid4.taskendpoint.model.Task> {
    ...
    protected GetTask(java.lang.Long id) {
      super(Taskendpoint.this, "GET", REST_PATH, null, com.velan.testandroid4.taskendpoint.model.Task.class);
   ...
   *
   * @param content the {@link com.velan.testandroid4.taskendpoint.model.Task}
   * @return the request
   */
  public InsertTask insertTask(com.velan.testandroid4.taskendpoint.model.Task content) throws java.io.IOException {
    InsertTask result = new InsertTask(content);
    initialize(result);
    return result;
  }

  public class InsertTask extends TaskendpointRequest<com.velan.testandroid4.taskendpoint.model.Task> {
     ...
     * @since 1.13
     */
    protected InsertTask(com.velan.testandroid4.taskendpoint.model.Task content) {
      super(Taskendpoint.this, "POST", REST_PATH, content, com.velan.testandroid4.taskendpoint.model.Task.class);
    }
  ...
  public class ListTask extends TaskendpointRequest<com.velan.testandroid4.taskendpoint.model.CollectionResponseTask> {
     ...
     */
    protected ListTask() {
      super(Taskendpoint.this, "GET", REST_PATH, null, com.velan.testandroid4.taskendpoint.model.CollectionResponseTask.class);
    }
   ...
   * @return the request
   */
  public UpdateTask updateTask(com.velan.testandroid4.taskendpoint.model.Task content) throws java.io.IOException {
    UpdateTask result = new UpdateTask(content);
    initialize(result);
    return result;
  }

  public class UpdateTask extends TaskendpointRequest<com.velan.testandroid4.taskendpoint.model.Task> {
     ...
     * @since 1.13
     */
    protected UpdateTask(com.velan.testandroid4.taskendpoint.model.Task content) {
      super(Taskendpoint.this, "PUT", REST_PATH, content, com.velan.testandroid4.taskendpoint.model.Task.class);
    }
